  ...
  if (!report) {
    return (
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-6 py-10">
        <div className="rounded-2xl border border-[color:var(--line)] bg-black/25 p-8 shadow-[0_18px_60px_rgba(0,0,0,0.55)]">
          <div className="text-xs uppercase tracking-[0.38em] text-[color:var(--paper)]/70">Level Clear</div>
          <h1 className="mt-2 font-display text-4xl text-[color:var(--paper)] md:text-5xl">关卡通过</h1>
          <p className="mt-2 text-sm text-[color:var(--paper)]/80">成绩数据缺失，返回菜单以继续。</p>
        </div>
  ...
  return (
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-6 py-10">
      <div className="relative overflow-hidden rounded-2xl border border-[color:var(--line)] bg-black/25 p-8 shadow-[0_18px_60px_rgba(0,0,0,0.55)]">
        ...
        <div className="relative flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="min-w-0">
            ...
            <h1 className="mt-2 font-display text-4xl text-[color:var(--paper)] md:text-5xl">第 {levelNo} 关通过</h1>
            <p className="mt-2 text-sm text-[color:var(--paper)]/80">确认后进入第 {nextLevelNo} 关。</p>
          </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-2xl border border-[color:var(--line)] bg-black/20 p-5 shadow-[0_18px_60px_rgba(0,0,0,0.45)]">
